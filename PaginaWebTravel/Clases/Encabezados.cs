...
namespace PaginaWebTravel.Clases
{
    public class Encabezados
    {
        ...
        public Encabezados(string pV_DOMINIO, string pV_CODIGO)
        {
            _PV_DOMINIO = pV_DOMINIO;
            _PV_CODIGO = pV_CODIGO;
            RecuperarDatos();
        }
        public Encabezados(string pV_TIPO_OPERACION, string pV_DOMINIO, string pV_CODIGO,
        ...
        //}
        public static DataTable GET_PAG_ENCABEZADO(string PV_ESTADO)
        {
            try
            {

                DbCommand cmd = db1.GetStoredProcCommand("GET_PAG_ENCABEZADO");
