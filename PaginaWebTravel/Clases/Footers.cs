...
namespace PaginaWebTravel.Clases
{
    public class Footers
    {
        ...
        public Footers(string pV_DOMINIO, string pV_CODIGO)
        {
            _PV_DOMINIO = pV_DOMINIO;
            _PV_CODIGO = pV_CODIGO;
            RecuperarDatos();
        }
        public Footers(string pV_TIPO_OPERACION, string pV_DOMINIO, string pV_CODIGO,
        ...
        //}
        public static DataTable GET_PAG_PIE(string PV_ESTADO)
        {
            try
            {

                DbCommand cmd = db1.GetStoredProcCommand("GET_PAG_PIE");
